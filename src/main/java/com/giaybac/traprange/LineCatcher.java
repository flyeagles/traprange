...
public class LineCatcher extends PDFGraphicsStreamEngine
{
    ...
    {
        try (PDDocument document = PDDocument.load(new File("E:\\0del\\hzdata1.pdf")))
        {
            PDPage page = document.getPage(24);
    ...
    {
        //System.out.println("appendRectangle:"+p0.getX()+":"+p0.getY()+"--"+p2.getX()+":"+p2.getY());
